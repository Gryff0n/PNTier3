...
public class FacadeScreenImpl implements FacadeScreen {
    ...
    @Override
    public void creerFilm(String titre, String realisateur, GenreFilm genre) throws GenreNotFoundException, NomFilmDejaExistantException {
        for (Film f : tous) {
